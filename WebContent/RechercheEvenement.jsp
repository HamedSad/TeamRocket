...
<body>
	...
	<%
		...
		String sql = "SELECT * FROM evenement WHERE lieu LIKE'%" + search + "%' OR titre LIKE'%" + search
				+ "%'  OR createur LIKE '%" + search + "%'  OR textEve LIKE '%" + search + "%'";

		ResultSet result = (ResultSet) st.executeQuery(sql);

		ArrayList<CreationEvenement> listeRechercheEvenement = new ArrayList<CreationEvenement>();
